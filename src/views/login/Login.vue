<template>
  <div class='Login'>
    ...
    <div class="btns">
      <el-button @click="touristTo" class="tour" type="success">游客参观</el-button>
      <el-button @click="touristToGit" class="github" size="mini" circle><i class="iconfont icon-github"></i>
      </el-button>
      <el-button @click="toLogin" class="author" type="warning">创作者</el-button>
    </div>
    <div class="animated zoomIn managerInfo">
      <ShiMask>
      </ShiMask>
    </div>
    <login-form :dialogVisible="loginDialogVisible" @cancel="cancel"></login-form>
  </div>
</template>
